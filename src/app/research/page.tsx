  ...
  const fetchCompoundData = async () => {
    ...
    try {
      ...
      if (
        ...
        console.log("Compound data:", compoundInfo);
      } else {
        ...
        <div className="mb-6 flex flex-col items-center md:flex-row md:justify-between">
          ...
          <div className="relative mt-4 flex flex-1 md:mt-0 md:justify-end">
            ...
            <button
              ...
              className="text-gray-500 absolute right-3 top-1/2 -translate-y-1/2 p-1 hover:text-black"
            >
              <Search />
            </button>
          </div>
              ...
              <p>
                ...
                {compoundData.CanonicalSMILES ? (
                  ...
                  <span className="text-red-500">
                    No SMILES available for rendering.
                  </span>
                )}
              </p>
